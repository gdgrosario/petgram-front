            ...
            <ul className="header-nav-pages__list">
                <li className="header-nav-pages__item">
                    <button className="header-nav-pages__btn">
                        <img className="header-nav-pages__svg header-nav-pages__svg--pointer" src={backBtn} alt="back" />
                    </button>
                </li>
                ...
                <li className="header-nav-pages__item">
                    <button className="header-nav-pages__btn">
                        <img className="header-nav-pages__svg header-nav-pages__svg--pointer" src={menuBtn} alt="back" />
                    </button>
                </li>
            </ul>
        </header>
